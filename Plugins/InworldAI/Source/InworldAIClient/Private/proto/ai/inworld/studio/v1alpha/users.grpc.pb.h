...
class Users final {
 public:
  ...
  #ifdef GRPC_CALLBACK_API_NONEXPERIMENTAL
  typedef ExperimentalWithCallbackMethod_GenerateTokenUser<ExperimentalWithCallbackMethod_LinkAccountUser<ExperimentalWithCallbackMethod_GetUser<ExperimentalWithCallbackMethod_UpdateUser<ExperimentalWithCallbackMethod_AcceptTos<Service > > > > > CallbackService;
  #endif

  typedef ExperimentalWithCallbackMethod_GenerateTokenUser<ExperimentalWithCallbackMethod_LinkAccountUser<ExperimentalWithCallbackMethod_GetUser<ExperimentalWithCallbackMethod_UpdateUser<ExperimentalWithCallbackMethod_AcceptTos<Service > > > > > ExperimentalCallbackService;
  template <class BaseClass>
